...
func (q *Queries) CreateWallet(ctx context.Context, balance int32) (pgtype.UUID, error) {
...
func (q *Queries) UpdateWallet(ctx context.Context, balance int32) (int32, error) {
	row := q.db.QueryRow(ctx, updateWallet, balance)
	err := row.Scan(&balance)
	return balance, err
}
